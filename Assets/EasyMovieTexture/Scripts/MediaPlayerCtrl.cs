...
public class MediaPlayerCtrl : MonoBehaviour {
	...
	//public GameObject m_TargetMaterialTwo = null;
	...
	private void Call_UpdateVideoTexture()
	{
		...
		/*
		if(m_TargetMaterialTwo)
		{
			if(m_TargetMaterialTwo.GetComponent<MeshRenderer>().material.mainTexture != m_VideoTexture)
			{
				m_TargetMaterialTwo.GetComponent<MeshRenderer>().material.mainTexture = m_VideoTexture;
			}
...
*/
	...
	private void Call_UpdateVideoTexture()
	{
		...
		if( m_CurrentState == MEDIAPLAYER_STATE.PLAYING)
		{
			...
			/*
			if(m_TargetMaterialTwo)
				m_TargetMaterialTwo.GetComponent<MeshRenderer>().material.mainTexture = _videoTexture;
*/
